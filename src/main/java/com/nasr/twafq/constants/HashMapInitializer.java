...
public class HashMapInitializer {
    ...
    public void init() {
        ...
        // Populate the map with data from MongoDB
        for (DataPair dataPair : dataPairService.getAllDataPairs()) {
            dataMap.put(Pair.of(dataPair.getKey1(), dataPair.getKey2()), dataPair.getValue());
        }
    }
